...
# s1 : So nguyen vua nhap
# t3 : So nguyen cuoi cung thu nhat
# t4 : So nguyen cuoi cung thu hai
main:
	jal input
	li $t1,10
	div $s1,$t1
	...
	jal Switch			 # set value for segments
...
input:
	la $a0,Mess1
	li $v0,4		# Nhap so nguyen: 
	syscall
	
	li $v0,5
	syscall		# Nhap du lieu tu ban phim
	add $s1,$zero,$v0
	jr $ra
